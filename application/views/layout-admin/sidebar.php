                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="<?php echo site_url('survey_controller/user_survey');?>" class="waves-effect"><i class="mdi mdi-account"></i><span> User </span></a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('survey_controller/perusahaan');?>" class="waves-effect">
                                    <i class="mdi mdi-view-dashboard"></i><span> Perusahaan </span>
                                </a>
                            </li>
                            <li>
