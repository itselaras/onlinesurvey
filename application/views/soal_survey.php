                                ...
                                <div class="col-xl-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <?php if (isset($soal)):?>
                                            <table id="datatable-soal" class="table table-striped table-bordered dt-responsive nowrap" style="overflow: auto;">
                                            <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>No Soal</th>
                                            ...
                                            <tr>
                                                <td><?php echo $i;?></td>
                                                <?php $i++;?>
                                                <td><?php echo $so->no_soal;?></td>
                                                <td><?php echo $so->soal;?></td>
                                                <td><?php echo $so->jenis;?></td>
                                            </tr>
                                            <?php endforeach;?>
                                            </tbody>
                                        </table>
